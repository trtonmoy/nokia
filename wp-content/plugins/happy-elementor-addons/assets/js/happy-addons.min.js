  ...
  $window.on("elementor/frontend/init", function () {
    ...
    var NewsTicker = ModuleHandler.extend({
      ...
      onElementChange: function onElementChange(changed_prop) {
        if (
          changed_prop === "item_space" ||
          changed_prop === "title_typography_font_size"
        ) {
          this.run();
        }
      },
    ...
    var Event_Calendar = function Event_Calendar($scope) {
      ...
      var option = {
        ...
        eventClick: function eventClick(info) {
          if ("yes" == showPopup) {
            ...
            var todayDateString =
                info.view.calendar.currentData.currentDate.toString(),
            ...
            if (info.event.url && info.event.extendedProps.external) {
              ...
              anchor.target = info.event.extendedProps.external
                ? "_blank"
                : "_self";
              anchor.rel = info.event.extendedProps.nofollow
                ? "nofollow noreferer"
                : "";
      ...
      $scope.find(".ha-ec-popup-wrapper").on("click", function (e) {
        ...
        if (
          ...
          e.target == popupClose[0] ||
          e.target == popupClose.find(".eicon-editor-close")[0]
        ) {
          popup
            .addClass("ha-ec-popup-removing")
            .removeClass("ha-ec-popup-ready");
        }
      });
    };
    ...
    var Creative_Button = function Creative_Button($scope) {
      ...
      if ("yes" == magnetic) {
        btn_wrap.on("mousemove", function (e) {
          var x =
            e.pageX - (btn_wrap.offset().left + btn_wrap.outerWidth() / 2);
          var y =
            e.pageY - (btn_wrap.offset().top + btn_wrap.outerHeight() / 2);
          btn.css(
            "transform",
    ...
    var BackgroundOverlay = function BackgroundOverlay($scope) {
      $scope.hasClass("elementor-element-edit-mode") &&
        $scope.addClass("ha-has-bg-overlay");
    };
    var fnHanlders = {
    ...
    var AgeGate = function AgeGate($scope, $) {
      if (elementorFrontend.isEditMode()) {
        ...
        /*confirm-age*/
        if (
          $scope.find(".ha-age-gate-wrapper.ha-age-gate-confirm-age").length
        ) {
        ...
        /*confirm-dob*/
        if (
          $scope.find(".ha-age-gate-wrapper.ha-age-gate-confirm-dob").length
        ) {
        ...
        /*confirm-by-boolean*/
        if (
          $scope.find(".ha-age-gate-wrapper.ha-age-gate-confirm-by-boolean")
            .length
        ) {
          $(".ha-age-gate-wrapper .ha-age-gate-confirm-yes-btn").on(
            "click",
            function () {
              localStorage.setItem("ha-age-gate-expire-time", endDate);
              $(this).closest(".ha-age-gate-wrapper").hide();
          ...
          $(".ha-age-gate-wrapper .ha-age-gate-confirm-no-btn").on(
            "click",
            function () {
              $(this)
                .closest(".ha-age-gate-boxes")
