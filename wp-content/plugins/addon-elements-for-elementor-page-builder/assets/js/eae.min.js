jQuery(window).on("elementor/frontend/init", function () {
  elementorFrontend.hooks.addAction(
    ...
    function (e) {
      var a = e.find(".eae-markers");
      0 != a.length &&
        (map = (function (t) {
          var n = (a = e.find(".eae-markers")).data("zoom"),
            i = t.find(".marker"),
            r = a.data("style"),
            s =
              (a.data("scroll"),
            ...
            d = new google.maps.Map(t[0], s);
          return (
            (d.markers = []),
            i.each(function () {
              !(function (t, n) {
                var i = a.data("animate");
                a.data("show-info-window-onload");
                a = e.find(".eae-markers");
                var r = new google.maps.LatLng(
                  t.attr("data-lat"),
                  t.attr("data-lng")
                );
                if (((icon_img = t.attr("data-icon")), "" != icon_img))
                  var s = {
                    url: t.attr("data-icon"),
                    scaledSize: new google.maps.Size(
                      t.attr("data-icon-size"),
                      t.attr("data-icon-size")
                    ),
                  };
...
!(function (e) {
  e(window).on("elementor/frontend/init", function () {
    ...
    let o = function (e, a) {
      ...
      e.find(".eae-chart-outer-container").each(function (e, a) {
        new Waypoint({
          element: a,
          handler: function (e) {
            "down" == e &&
              (a.classList.contains("trigger") ||
                (a.classList.add("trigger"), new Chart(n, i)));
          },
          offset: "70%",
        });
      });
      ...
      elementorFrontend.hooks.addAction(
        ...
        function (e, a) {
          ...
          if (i.hasOwnProperty("mobile"))
            for (const e in r)
              n.hasOwnProperty(e) && (sliderData[e] = n[e].mobile),
                n.thumbs.hasOwnProperty(e) &&
                  (sliderData.thumbs.swiper[e] = n.thumbs[e].mobile);
          const s = {},
            d = {};
          if (
            (n.hasOwnProperty("breakpoints_value") &&
              Object.keys(n.breakpoints_value).map((e) => {
                const a = parseInt(n.breakpoints_value[e]);
                if (("desktop" === e && (e = "default"), "mobile" !== e)) {
                  const t = parseInt(n.spaceBetween[e]);
                  s[a - 1] = { spaceBetween: t };
                  const i = parseInt(n.thumbs.spaceBetween[e]),
                    r = parseInt(n.thumbs.slidesPerView[e]);
                  d[a - 1] = { spaceBetween: i, slidesPerView: r };
                }
              }),
            (sliderData.breakpoints = s),
            (sliderData.thumbs.swiper.breakpoints = d),
            void 0 !== n.autoplay &&
