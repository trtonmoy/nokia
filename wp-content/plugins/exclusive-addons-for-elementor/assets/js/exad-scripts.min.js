(function ($) {
  ...
  var exclusiveAnimatedText = function ($scope, $) {
    var animatedWrapper = $scope.find(".exad-typed-strings").eq(0),
      animateSelector = animatedWrapper.find(
  ...
  var exclusiveCorona = function ($scope, $) {
    ...
    var continentBtn = exadCoronaWrapper.find(
      "#exad-covid-filters .exad-covid-continent-btn"
    );
    var parentClass = exadCoronaWrapper.find(
  ...
  var exclusiveCountdownTimer = function ($scope, $) {
    ...
    if (
      "undefined" !== typeof countdownTimerWrapper &&
      null !== countdownTimerWrapper
    ) {
      ...
      if ($.isFunction($.fn.countdown)) {
        $this
          .countdown(finalDate, function (event) {
            $(this).html(
              event.strftime(
                ' <div class="exad-countdown-container"><div class="exad-countdown-timer-wrapper"><span class="exad-countdown-count">%-D </span><span class="exad-countdown-title">' +
                  day +
                  '</span></div></div><div class="exad-countdown-container"><div class="exad-countdown-timer-wrapper"><span class="exad-countdown-count">%H </span><span class="exad-countdown-title">' +
                  hours +
                  '</span></div></div><div class="exad-countdown-container"><div class="exad-countdown-timer-wrapper"><span class="exad-countdown-count">%M </span><span class="exad-countdown-title">' +
                  minutes +
                  '</span></div></div><div class="exad-countdown-container"><div class="exad-countdown-timer-wrapper"><span class="exad-countdown-count">%S </span><span class="exad-countdown-title">' +
                  seconds +
                  "</span></div></div>"
              )
            );
  ...
  var exclusiveFilterablePost = function ($scope, $) {
    if ($.isFunction($.fn.isotope)) {
      ...
      $container.isotope({ filter: "*", animationOptions: { queue: true } });
      $(filterableItem + " .exad-filterable-menu li").click(function () {
        $(filterableItem + " .exad-filterable-menu li.current").removeClass(
          "current"
        );
  ...
  var exclusiveFilterableGallery = function ($scope, $) {
    if ($.isFunction($.fn.isotope)) {
      ...
      $(galleryItem + " .exad-gallery-menu button").click(function () {
        $(galleryItem + " .exad-gallery-menu button.current").removeClass(
          "current"
        );
        $(this).addClass("current");
        var selector = $(this).attr("data-filter");
  ...
  var exclusiveGoogleMaps = function ($scope, $) {
    if ($.isFunction($.fn.gmap3)) {
      ...
      googleMaps
        ...
        .styledmaptype("standard", [], { name: "standard" })
        .styledmaptype(
          "retro",
          [
  ...
  var exclusiveImageComparison = function ($scope, $) {
    var imageComparison = $scope.find(".exad-image-comparision-element").eq(0),
      ...
      exadMoveWithHandleOnly = imageComparison.data(
        "exad-move_with_handle_only"
      ),
  ...
  var exclusiveLogoCarousel = function ($scope, $) {
    var logoCarouselWrapper = $scope.find(".exad-logo-carousel-element").eq(0),
      ...
      loop =
        undefined !== logoCarouselWrapper.data("loop")
          ? logoCarouselWrapper.data("loop")
          : false,
      autoPlay =
        undefined !== logoCarouselWrapper.data("autoplay")
          ? logoCarouselWrapper.data("autoplay")
          : false,
      autoplaySpeed =
        undefined !== logoCarouselWrapper.data("autoplayspeed")
          ? logoCarouselWrapper.data("autoplayspeed")
          : false,
      Smooth =
        undefined !== logoCarouselWrapper.data("smooth")
          ? logoCarouselWrapper.data("smooth")
          : false,
      SmoothSpeed =
        undefined !== logoCarouselWrapper.data("smooth-speed")
          ? logoCarouselWrapper.data("smooth-speed")
          : 300;
    ...
    if ($.isFunction($.fn.slick)) {
      logoCarouselWrapper.slick({
        ...
        cssEase: cssEase,
        prevArrow:
          '<div class="exad-logo-carousel-prev"><i class="eicon-chevron-left"></i></div>',
        nextArrow:
          '<div class="exad-logo-carousel-next"><i class="eicon-chevron-right"></i></div>',
        responsive: [
          {
            breakpoint: 1024,
            settings: { slidesToShow: carouselColumnTablet },
          },
          { breakpoint: 768, settings: { slidesToShow: carouselColumnTablet } },
          { breakpoint: 450, settings: { slidesToShow: carouselColumnMobile } },
        ],
      });
    }
  };
  ...
  var exclusivePostGrid = function ($scope, $) {
    ...
    var exadPostArticle = exadPostgridWrapped.find(
      ".exad-post-grid-three .exad-post-grid-container.exad-post-grid-equal-height-yes"
    );
    var exadPostWrapper = exadPostgridWrapped.find(".exad-row-wrapper");
    exadPostArticle.matchHeight({ byRow: 0 });
    ...
    $(btn).on("click", function (e) {
      ...
      $.ajax({
        ...
        data: {
          ...
          category_position_over_image: $(this).data(
            "category_position_over_image"
          ),
        ...
        success: function (html) {
          if (html.length > 0) {
            ...
            page += 1;
            setTimeout(function () {
              var newExadPostArticle = exadPostgridWrapped.find(
                ".exad-post-grid-three .exad-post-grid-container.exad-post-grid-equal-height-yes"
              );
              newExadPostArticle.matchHeight({ byRow: 0 });
            }, 10);
          } else {
            btn.remove();
          }
  ...
  $(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-exclusive-accordion.default",
      exclusiveAccordion
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-post-grid.default",
      exclusivePostGrid
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-exclusive-alert.default",
      exclusiveAlert
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-animated-text.default",
      exclusiveAnimatedText
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-exclusive-button.default",
      exclusiveButton
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-countdown-timer.default",
      exclusiveCountdownTimer
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-filterable-gallery.default",
      exclusiveFilterableGallery
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-google-maps.default",
      exclusiveGoogleMaps
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-image-comparison.default",
      exclusiveImageComparison
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-image-magnifier.default",
      exclusiveImageMagnifier
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-logo-carousel.default",
      exclusiveLogoCarousel
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-modal-popup.default",
      exclusiveModalPopup
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-news-ticker.default",
      exclusiveNewsTicker
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-progress-bar.default",
      exclusiveProgressBar
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-exclusive-tabs.default",
      exclusiveTabs
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-covid-19.default",
      exclusiveCorona
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-facebook-feed.default",
      exadFacebookFeed
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-google-reviews.default",
      exclusiveGoogleReviews
    );
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-filterable-post.default",
      exclusiveFilterablePost
    );
    elementorFrontend.hooks.addAction(
